...
import { Zap, Eye, EyeOff, ArrowRight, Mail, Lock, User, UserPlus } from 'lucide-react';
...
@media (max-width: 700px) {
  ...
  .lp-name-row { flex-direction: column; gap: 0; }
}
`;
...
export function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error || data.email?.[0] || data.username?.[0] || 'Registration failed. Please try again.');
      } else {
      ...
      <div className="lp-inner">
        ...
        <div className="lp-left">
          ...
          <div className="lp-left-body">
            ...
            <div className="lp-left-title">Join your campus community</div>
            <p className="lp-left-sub">
              Create an account to discover events, connect with clubs, and stay updated with everything happening at your university.
            </p>
        ...
        <div className="lp-right">
          <div className="lp-right-title">Create account</div>
          <div className="lp-right-sub">Enter your details to get started</div>
